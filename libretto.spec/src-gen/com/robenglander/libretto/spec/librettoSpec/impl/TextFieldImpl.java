 ...
 * </p>
 * <ul>
 *   <li>{@link com.robenglander.libretto.spec.librettoSpec.impl.TextFieldImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextFieldImpl extends MinimalEObjectImpl.Container implements TextField
{
  ...
  {
    return LibrettoSpecPackage.Literals.TEXT_FIELD;
  }
  ...
  public NotificationChain basicSetValue(TextValue newValue, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LibrettoSpecPackage.TEXT_FIELD__VALUE, oldValue, newValue);
  ...
  public void setValue(TextValue newValue)
  {
    if (newValue != value)
    {
      ...
      if (value != null)
        msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LibrettoSpecPackage.TEXT_FIELD__VALUE, null, msgs);
      if (newValue != null)
        msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LibrettoSpecPackage.TEXT_FIELD__VALUE, null, msgs);
      msgs = basicSetValue(newValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LibrettoSpecPackage.TEXT_FIELD__VALUE, newValue, newValue));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case LibrettoSpecPackage.TEXT_FIELD__VALUE:
